            ...
            <details className="rev" style={{ marginTop: 12 }}>
              ...
              <form action={saveTemplate} style={{ marginTop: 8 }}>
                ...
                <label className="field">
                  <span>タイトル</span>
                  <input name="title" type="text" defaultValue={tpl.title} required />
                </label>
                <label className="field">
                  <span>本文</span>
                  <textarea name="body" rows={12} defaultValue={tpl.body} required />
                </label>
                <label className="field">
              ...
              {revisions.map((r) => (
                <div key={r.id} style={{ marginTop: 8 }}>
                  ...
                  {r.version !== tpl.version ? (
                    <form action={restoreTemplateRevision} style={{ marginTop: 6 }}>
                      <input type="hidden" name="back_to" value="/my/template" />
